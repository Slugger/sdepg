...
import sagex.epg.schedulesdirect.data.GeneratedProgram

class ProgramGenerator extends Generator {
	static private final Logger LOG = Logger.getLogger(ProgramGenerator)

	ProgramGenerator(def root) { super(root, 'prog') }

	protected Collection<GeneratedProgram> generate(String scriptName) {
